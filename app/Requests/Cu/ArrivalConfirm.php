...
#[OA\Schema(schema: 'request.cu.ArrivalConfirm')]
class ArrivalConfirm extends Request
{
    #[OA\Property(description: '매장코드')]
    public readonly string $shop_code;
    #[OA\Property(description: '주문번호')]
    public readonly string $no_order;
    #[OA\Property(description: '알림 완료처리')]
    public readonly string $yn_confrim;
    ...
    public function __construct()
    {
        ...
        $this->yn_confrim = data_get($valid, 'yn_confrim');
