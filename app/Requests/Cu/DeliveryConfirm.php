...
#[OA\Schema(schema: 'request.cu.DeliveryConfirm')]
class DeliveryConfirm extends Request
{
    #[OA\Property(description: '매장코드')]
    public readonly string $shop_code;
    #[OA\Property(description: '주문번호')]
    public readonly string $no_order;
    #[OA\Property(description: '전달완료 여부')]
    public readonly string $yn_delivery;
    ...
    public function __construct()
    {
        ...
        $this->yn_delivery = data_get($valid, 'yn_delivery');
