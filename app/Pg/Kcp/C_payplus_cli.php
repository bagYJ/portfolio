...
class   C_payplus_cli
{
    ...
    public function mf_do_tx(
        ...
        $this->m_res_msg =
        $this->m_res_data["res_msg"] =  iconv('CP949', 'UTF-8', data_get($this->m_res_data, 'res_msg'));
        $this->m_res_data["card_name"] =  iconv('CP949', 'UTF-8', data_get($this->m_res_data, 'card_name'));
        $this->m_res_data["acqu_name"] =  iconv('CP949', 'UTF-8', data_get($this->m_res_data, 'acqu_name'));
    }
