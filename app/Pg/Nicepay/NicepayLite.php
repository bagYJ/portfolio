...
class NicepayLite
{
    ...
    public function startAction()
    {
        ...
        if (!is_dir($this->m_NicepayHome)) {
            mkdir($this->m_NicepayHome);
        }
                    ...
                    if (trim($this->m_ActionType) == "PYO" && trim($this->m_PayMethod) == "MOBILE_BILLING") {
                        ...
                        if (trim($this->m_ActionType) == "PYO" && trim($this->m_PayMethod) == "BILLKEY") {
                            ...
                            if (trim($this->m_ActionType) == "PYO" && trim($this->m_PayMethod) == "ESCROW") {
                                ...
                                if ($this->m_charSet == "UTF8") {
                                    $this->m_queryString["BuyerAddr"] = iconv("UTF-8", "CP949", $this->m_BuyerAddr);
                                    ...
                                    $this->m_queryString["RefundName"] = iconv("UTF-8", "CP949", $this->m_RefundName);
                                }
                                // 지급 대행 서브몰 등록
                            } else {
    ...
    public function ParseMsg($result_string, $NICELog)
    {
        ...
        for ($num = 0; $num < count($string_arr); $num++) {
            ...
            if ($this->m_charSet == "UTF-8") {
                $this->m_ResultData[$parse_str[0]] = iconv("CP949", "UTF-8", $parse_str[1]);
            } else {
